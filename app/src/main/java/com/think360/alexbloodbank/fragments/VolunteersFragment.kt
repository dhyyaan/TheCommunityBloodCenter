...
class VolunteersFragment : BaseFragment() {
    ...
    companion object {
        fun newInstance(): VolunteersFragment {
            return VolunteersFragment()
        }
    }

    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view =  inflater!!.inflate(R.layout.volunteers_fragment, container, false)
    ...
    private fun volunteerlist() {

        swiperefresh.setRefreshing(true)
        apiService.volunteerlist(AppController.getSharedPref().getString("user_id","")).enqueue(object : Callback<Responce.HostListResponce> {
    ...
    override fun onAttach(context: Context) {
        ...
        ( context.applicationContext as AppController).getComponent().inject(this@VolunteersFragment)
    }
}